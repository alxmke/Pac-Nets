...
def constructBayesNet(gameState):
    ...
    for housePos in gameState.getPossibleHouses():
            for obsPos in gameState.getHouseWalls(housePos):
                ...
                edges.append((FOOD_HOUSE_VAR, obsVar)) # forming prod(FOOD_HOUSE_VAR, obsVars)
                edges.append((GHOST_HOUSE_VAR, obsVar)) # forming prod(GHOST_HOUSE_VAR, obsVars)
